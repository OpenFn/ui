...
import MappingSubmissions from "./components/MappingSubmissions";
...
const App = React.createClass({
    ...
    routes: {
      ...
      '/mapping/:mappingId/submissions': 'mappingSubmissionsList'
    },
    ...
    mappingSubmissionsList: function(mappingId) {
      return <MappingSubmissions mappingId={mappingId} />;
    },
